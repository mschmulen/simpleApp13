...
public class IAPManager : NSObject{
    ...
    public func isActive(product : SKProduct) -> Bool {
    ...
    public func purchaseProduct(product : SKProduct, success: @escaping SuccessBlock, failure: @escaping FailureBlock){
    ...
    public func restorePurchases(success: @escaping SuccessBlock, failure: @escaping FailureBlock){
        self.successBlock = success
        self.failureBlock = failure
